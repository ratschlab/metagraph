...
result_file = os.path.join(basedir, 'queries', 'gencode.v30.first_exons_non_ovlp.result.txt.gz')
hdf5_out_file = os.path.join(basedir, 'queries', 'gencode.v30.first_exons_non_ovlp.result.hdf5')

matching = sp.zeros((100000, 10000), dtype='int16')
expression = sp.zeros((100000, 10000), dtype='int')
