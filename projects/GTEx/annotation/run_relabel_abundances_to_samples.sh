...
anno_in=${basedir}/gtex/graphs/output_k${K}_trimmed_clean.abundance.column.annodbg
anno_out=${basedir}/gtex/graphs/output_k${K}_trimmed_clean.samples.column.annodbg
