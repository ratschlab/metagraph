...
splice_junctions_out = '/cluster/work/grlab/projects/metagenome/data/gtex/queries/gencode.v30.all_junctions.fa'
splice_junctions_len_out = '/cluster/work/grlab/projects/metagenome/data/gtex/queries/gencode.v30.all_junctions.len.tsv'
...
out = open(splice_junctions_out, 'w')
out_len = open(splice_junctions_len_out, 'w')
