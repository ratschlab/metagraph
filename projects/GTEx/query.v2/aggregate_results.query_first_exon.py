...
result_file = os.path.join(basedir, 'queries', 'gencode.v30.first_exons.result.txt.gz')
hdf5_out_file = os.path.join(basedir, 'queries', 'gencode.v30.first_exons.result.hdf5')
