...
log=${outdir}/amr_CARD_nucleotide_fasta_protein_homolog_model_k${K}.align_step2.log
out=${outdir}/amr_CARD_nucleotide_fasta_protein_homolog_model_k${K}.align_step2.tsv
query=${outdir}/amr_CARD_nucleotide_fasta_protein_homolog_model_k${K}.fa
if [ ! -f ${query} ]
then
