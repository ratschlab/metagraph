...
graphdir=${basedir}/metasub/graphs_metagraph/output_k19
outdir=${basedir}/metasub/graphs_metagraph/output_k19_uncleaned_pstudy_realign
mkdir -p $outdir
...
do
    ...
    for graph in ${graphdir}/${uuid}*.dbg
    do
