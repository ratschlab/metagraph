...
${metagraph} build -p $threads -k $K -o ${outdir}/\${uuid} --canonical --count-kmers \${fq1} \${fq2}" | bsub -J contigs_k${K}[15] -o ${outdir}.graph_build.lsf -We 20:00 -n $threads -M $mem -R "rusage[mem=${pmem}]" -R "span[hosts=1]"
