...
typedef StaticBinRelAnnotator<binmat::RowDiff<binmat::BRWT>, std::string> BRWTRowDiffAnnotator;
...
template <>
inline const std::string BRWTRowDiffAnnotator::kExtension = ".brwt_row_diff.annodbg";
} // namespace annot
} // namespace mtg
