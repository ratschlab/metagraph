...
typedef StaticBinRelAnnotator<matrix::CSCMatrix<binmat::ColumnMajor, CountsVector>, std::string> IntColumnAnnotator;
...
template <>
inline const std::string IntColumnAnnotator::kExtension = ".int_column.annodbg";
template <>
