...
typedef StaticBinRelAnnotator<matrix::ColumnMajor, std::string> ColumnMajorAnnotator;
...
template <>
inline const std::string ColumnMajorAnnotator::kExtension = ".column.annodbg";
template <>
