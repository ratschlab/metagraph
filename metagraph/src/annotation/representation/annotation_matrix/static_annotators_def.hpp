...
typedef StaticBinRelAnnotator<binmat::RowDiff<binmat::RowSparseDisk>, std::string> RowDiffSparseDiskAnnotator;
...
template <>
inline const std::string RowDiffSparseDiskAnnotator::kExtension = ".row_diff_sparse_disk.annodbg";
template <>
