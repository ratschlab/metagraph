#ifndef __DBG_HASH_FAST5_HPP__
#define __DBG_HASH_FAST5_HPP__
...
class DBGHashFast5 : public DeBruijnGraph {
  public:
    explicit DBGHashFast5(size_t k,
    ...
    static constexpr auto kExtension = ".hashfast5dbg";

    class DBGHashFast5Interface : public DeBruijnGraph {
      public:
        virtual ~DBGHashFast5Interface() {}
  ...
  private:
    static std::unique_ptr<DBGHashFast5Interface>
    initialize_graph(size_t k, bool canonical_mode, bool packed_serialization);

    std::unique_ptr<DBGHashFast5Interface> hash_dbg_;
};

#endif // __DBG_HASH_FAST5_HPP__
