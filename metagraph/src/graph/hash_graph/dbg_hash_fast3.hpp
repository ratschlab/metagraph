#ifndef __DBG_HASH_FAST3_HPP__
#define __DBG_HASH_FAST3_HPP__
...
class DBGHashFast3 : public DeBruijnGraph {
  public:
    explicit DBGHashFast3(size_t k,
    ...
    static constexpr auto kExtension = ".hashfast3dbg";

    class DBGHashFast3Interface : public DeBruijnGraph {
      public:
        virtual ~DBGHashFast3Interface() {}
  ...
  private:
    static std::unique_ptr<DBGHashFast3Interface>
    initialize_graph(size_t k, bool canonical_mode, bool packed_serialization);

    std::unique_ptr<DBGHashFast3Interface> hash_dbg_;
};

#endif // __DBG_HASH_FAST3_HPP__
