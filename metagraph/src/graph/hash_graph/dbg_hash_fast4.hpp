#ifndef __DBG_HASH_FAST4_HPP__
#define __DBG_HASH_FAST4_HPP__
...
class DBGHashFast4 : public DeBruijnGraph {
  public:
    explicit DBGHashFast4(size_t k,
    ...
    static constexpr auto kExtension = ".hashfast4dbg";

    class DBGHashFast4Interface : public DeBruijnGraph {
      public:
        virtual ~DBGHashFast4Interface() {}
  ...
  private:
    static std::unique_ptr<DBGHashFast4Interface>
    initialize_graph(size_t k, bool canonical_mode, bool packed_serialization);

    std::unique_ptr<DBGHashFast4Interface> hash_dbg_;
};

#endif // __DBG_HASH_FAST4_HPP__
