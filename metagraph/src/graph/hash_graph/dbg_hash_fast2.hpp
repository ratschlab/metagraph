#ifndef __DBG_HASH_FAST2_HPP__
#define __DBG_HASH_FAST2_HPP__
...
class DBGHashFast2 : public DeBruijnGraph {
  public:
    explicit DBGHashFast2(size_t k,
  ...
  private:
    static std::unique_ptr<DBGHashFast2Interface>
    initialize_graph(size_t k, bool canonical_mode, bool packed_serialization);

    std::unique_ptr<DBGHashFast2Interface> hash_dbg_;
};

#endif // __DBG_HASH_FAST2_HPP__
