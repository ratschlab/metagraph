...
class bit_vector : public bitmap {
  public:
    ...
    virtual std::pair<bool, uint64_t> inverse_select(uint64_t id, bool condition) const {
...
class bit_vector_rrr : public bit_vector {
  ...
  public:
    ...
    std::pair<bool, uint64_t> inverse_select(uint64_t id, bool condition) const override;
...
class bit_vector_adaptive : public bit_vector {
  ...
  public:
    ...
    virtual std::pair<bool, uint64_t> inverse_select(uint64_t id, bool condition) const override final {
        return vector_->inverse_select(id, condition);
    }
