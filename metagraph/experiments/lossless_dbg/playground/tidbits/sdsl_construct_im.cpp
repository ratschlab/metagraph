...
void t7() {
    int_vector_buffer<8> test("test", std::ios::out, 1024 * 1024, 1, false);
    test.push_back(0);
    test.push_back(1);
    test.push_back(2);
    test.push_back(3);
...
int main(int argc, char **argv) {
    ...
    // t6(); // wrong, assertion failed: (i < size()), function operator[], file
    // ...../sdsl-lite/include/sdsl/wt_rlmn.hpp t7(); // works, not using construct_im
    return 0;
}