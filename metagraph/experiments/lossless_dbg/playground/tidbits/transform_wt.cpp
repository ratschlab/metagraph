...
int main(int argc, char *argv[]) {
    ...
    sdsl::wt_rlmn<t_bitvector,t_bitvector::rank_1_type,t_bitvector::select_1_type,wt_huff<
            t_bitvector,
            t_bitvector::rank_1_type,
            t_bitvector::select_1_type,
            t_bitvector::select_0_type,
            byte_tree<>
            >
    > wt_b;
