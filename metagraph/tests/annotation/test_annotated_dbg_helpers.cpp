...
template std::unique_ptr<AnnotatedDBG> build_anno_graph<DBGSSHash, RowFlatAnnotator>(uint64_t, const std::vector<std::string> &, const std::vector<std::string>&, DeBruijnGraph::Mode, bool);
