...
TYPED_TEST(AnnotatorDynamicTest, EmptyRows) {
    ...
    EXPECT_EQ(0u, this->annotation->get_labels(0).size());
    EXPECT_EQ(0u, this->annotation->get_labels(1).size());
    EXPECT_EQ(0u, this->annotation->get_labels(2).size());
    EXPECT_EQ(0u, this->annotation->get_labels(3).size());
    EXPECT_EQ(0u, this->annotation->get_labels(4).size());
}
...
TYPED_TEST(AnnotatorPreset2Test, GetLabels) {
    EXPECT_EQ(convert_to_set({"Label0", "Label2", "Label8"}),
              convert_to_set(this->annotation->get_labels(0)));
...
TYPED_TEST(AnnotatorTest, LabelExists) {
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label0"));
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label1"));
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label2"));
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label3"));
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label8"));
}

TYPED_TEST(AnnotatorPresetTest, LabelExists) {
    EXPECT_TRUE(this->annotation->get_label_encoder().label_exists("Label0"));
    EXPECT_TRUE(this->annotation->get_label_encoder().label_exists("Label1"));
    EXPECT_TRUE(this->annotation->get_label_encoder().label_exists("Label2"));
    EXPECT_FALSE(this->annotation->get_label_encoder().label_exists("Label3"));
    EXPECT_TRUE(this->annotation->get_label_encoder().label_exists("Label8"));
}
...
TYPED_TEST(AnnotatorDynamicTest, add_label) {
    ...
    EXPECT_EQ(convert_to_set({"0"}), convert_to_set(annotation.get_labels(0)));
    EXPECT_EQ(convert_to_set({"0", "2"}), convert_to_set(annotation.get_labels(1)));
    EXPECT_EQ(convert_to_set({"1"}), convert_to_set(annotation.get_labels(2)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(annotation.get_labels(3)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(annotation.get_labels(4)));
}
...
TYPED_TEST(AnnotatorDynamicTest, add_label_long_sparse) {
    ...
    EXPECT_EQ(convert_to_set({"0"}), convert_to_set(annotation.get_labels(0)));
    EXPECT_EQ(convert_to_set({"0", "1"}), convert_to_set(annotation.get_labels(4'999)));
    EXPECT_EQ(convert_to_set({"2"}), convert_to_set(annotation.get_labels(1'000'001)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(annotation.get_labels(1'500'000)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(annotation.get_labels(1'900'000)));
}
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_first_column_to_empty_annotation) {
    ...
    this->annotation->add_labels({ 0 }, { "Label0", "Label2", "Label8" });
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_no_empty_rows) {
    ...
    ASSERT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(3)));
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_one_empty_row) {
    ...
    EXPECT_EQ(convert_to_set({ "Label1", "Label2" }), convert_to_set(this->annotation->get_labels(2)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(3)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(4)));
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_last_row) {
    ...
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(3)));
    EXPECT_EQ(convert_to_set({ "Label8" }), convert_to_set(this->annotation->get_labels(4)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(5)));
}
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_empty_rows) {
    ...
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(7)));
...
TYPED_TEST(AnnotatorDynamicNoSparseTest, insert_empty_rows_many) {
    ...
    this->annotation->add_labels({ 0 }, { "Label0", "Label2", "Label8" });
    this->annotation->add_labels({ 2 }, { "Label1", "Label2" });
    this->annotation->add_labels({ 4 }, { "Label8" });
...
TYPED_TEST(AnnotatorPreset2Test, RenameColumns) {
    ...
    EXPECT_EQ(convert_to_set({ "Label0", "Label2Renamed", "Label8Renamed" }), convert_to_set(this->annotation->get_labels(0)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(1)));
    EXPECT_EQ(convert_to_set({ "Label1", "Label2Renamed" }), convert_to_set(this->annotation->get_labels(2)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(3)));
    EXPECT_EQ(convert_to_set({ "Label8Renamed" }), convert_to_set(this->annotation->get_labels(4)));
}
...
TYPED_TEST(AnnotatorPreset2Test, SwapColumns) {
    ...
    EXPECT_EQ(convert_to_set({ "Label0", "Label8", "Label2" }), convert_to_set(this->annotation->get_labels(0)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(1)));
    EXPECT_EQ(convert_to_set({ "Label1", "Label8" }), convert_to_set(this->annotation->get_labels(2)));
    EXPECT_EQ(convert_to_set({}), convert_to_set(this->annotation->get_labels(3)));
