...
// TYPED_TEST(MaskedDeBruijnGraphTest, CallUnitigsSingleKmerForm) {
//     for (size_t num_threads = 0; num_threads < 5; ++num_threads) {
...
//                 sdsl::bit_vector stable_mask(full_graph->max_index() + 1, true);
...
//                     stable_mask[i] = false;
//                 });
//                 MaskedDeBruijnGraph stable_graph(
//                     full_stable_graph,
...
// TYPED_TEST(MaskedDeBruijnGraphCanonicalTest, CallUnitigsCheckHalfSingleKmerForm) {
//     for (size_t num_threads = 0; num_threads < 5; ++num_threads) {
