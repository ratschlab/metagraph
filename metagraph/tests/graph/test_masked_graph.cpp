...
TYPED_TEST(MaskedStableDeBruijnGraphTest, CallUnitigsWithNodesNoMask) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallPathsWithNodesNoMask) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallUnitigsWithNodesNoMask) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedStableDeBruijnGraphTest, CallPathsWithNodesMaskFirstKmer) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedStableDeBruijnGraphTest, CallUnitigsWithNodesMaskFirstKmer) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallPathsWithNodesMaskFirstKmer) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallUnitigsWithNodesMaskFirstKmer) {
    for (size_t k = 3; k <= 10; ++k) {
        for (const std::vector<std::string> &sequences
                : { std::vector<std::string>({ "AAACACTAG", "AACGACATG" }),
                    std::vector<std::string>({ "AGACACTGA", "GACTACGTA", "ACTAACGTA" }),
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallUnitigsWithNodesMaskTangle) {
    size_t k = 4;
    // TTGC      GCACGGGTC
    //      TGCA
    // ATGC      GCAGTGGTC
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallContigsWithNodesMaskPath) {
    for (size_t k = 3; k <= 10; ++k) {
        std::vector<std::string> sequences { "ATGCAGTACTCAG",
                                             "ATGCAGTACTGAG",
                                             "GGGGGGGGGGGGG" };
...
TYPED_TEST(MaskedDeBruijnGraphTest, CallUnitigsWithNodesMaskPath) {
    size_t k = 4;
