...
class DBGSuccinctCached : public DBGSuccinct {
  public:
    template <typename... Args>
    DBGSuccinctCached(Args&&... args)
          : DBGSuccinct(std::forward<Args>(args)...) {}
};

class DBGSuccinctRCIndexed : public DBGSuccinct {
  public:
    template <typename... Args>
    DBGSuccinctRCIndexed(Args&&... args)
          : DBGSuccinct(std::forward<Args>(args)...) {}
};
...
typedef ::testing::Types<DBGBitmap,
                         ...
                         DBGSuccinctCached,
                         DBGSuccinctUnitigIndexed> GraphTypes;
...
typedef ::testing::Types<DBGBitmap,
                         ...
                         DBGSuccinctRCIndexed,
                         DBGSuccinctCached,
                         DBGSuccinctUnitigIndexed> StableGraphTypes;

typedef ::testing::Types<DBGHashFast, DBGSuccinct, DBGSuccinctUnitigIndexed> FewGraphTypes;
