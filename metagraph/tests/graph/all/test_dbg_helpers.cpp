...
build_graph(uint64_t k,
    ...
    if (mode == DBGMode::PRIMARY) {
        ...
        return std::make_shared<CanonicalDBG>(make_graph_primary<Graph>(graph), true, 2);
    }
...
build_graph<DBGHashString>(uint64_t k,
    ...
    if (mode == DBGMode::PRIMARY) {
        ...
        return std::make_shared<CanonicalDBG>(make_graph_primary<DBGHashString>(graph), true, 2);
    }
...
build_graph<DBGBitmap>(uint64_t k,
    ...
    if (mode == DBGMode::PRIMARY) {
        ...
        return std::make_shared<CanonicalDBG>(make_graph_primary<DBGBitmap>(graph), true, 2);
    }
...
build_graph<DBGSuccinct>(uint64_t k,
    ...
    if (mode == DBGMode::PRIMARY) {
        ...
        return std::make_shared<CanonicalDBG>(make_graph_primary<DBGSuccinct>(graph), true, 2);
    }
