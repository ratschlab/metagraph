...
class TestQuery(unittest.TestCase):
    ...
    def test_query_all_graphs(self, graph_repr):
        ...
        for anno_repr in ['row', 'column']:
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 11349)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 11417)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 19627)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 19703)
    ...
    def test_query_all_graphs_batch(self, graph_repr):
        ...
        for anno_repr in ['row', 'column']:
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 10234)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 10256)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 20224)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 20258)
...
class TestQueryCanonical(unittest.TestCase):
    ...
    def test_query_all_graphs(self, graph_repr):
        ...
        for anno_repr in ['row', 'column']:
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 11478)
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 11551)
    ...
    def test_query_all_graphs_batch(self, graph_repr):
        ...
        for anno_repr in ['row', 'column']:
            ...
            res = subprocess.run(query_command.split(), stdout=PIPE, stderr=PIPE)
            self.assertEqual(res.returncode, 0)
            self.assertEqual(len(res.stdout), 9479)
