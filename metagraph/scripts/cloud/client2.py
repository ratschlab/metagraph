...
if __name__ == '__main__':
    ...
    parser.add_argument('--destination', default='gs://mg26/clean/',
                        help='Host/directory where the cleaned BOSS graphs are copied to')
    parser.add_argument('--log_destination', default='gs://mg26/logs',
    ...
    if not args.server:
        ...
        if subprocess.call(['gsutil', 'cp', 'gs://mg26/server', '/tmp/server'], stdout=subprocess.PIPE,
