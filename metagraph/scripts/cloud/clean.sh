...
execute metagraph clean -v -p "$cores" --min-count 1 --num-singletons "${num_singletons}"  --prune-unitigs 0 --fallback -1 --prune-tips 62 --to-fasta -o "${output_file}" "${input_file}"
